...
spark = SparkSession.builder.appName("MosquittoSpark").getOrCreate()
spark.sparkContext.setLogLevel("OFF")

# Lee el archivo CSV con los datos de los vuelos
df = spark.read.csv("/home/vagrant/BBS71/Flights.csv", header=True, inferSchema=True)
